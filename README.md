...
Para poder crear o registrar un producto, realice un Post como se muestra en la imagen:

![](/imagenes/02-A.png)

## Ver todos los productos:

Para poder ver todos los productos registrados, realice un Get como se muestra en la imagen:

![](/imagenes/03.png)

## Ver producto por ID:

Para poder ver un producto por su ID, realice un Get como se muestra en la imagen:

![](/imagenes/04.png)

## Cambiar un producto por ID:

Para poder cambiar los valores de un producto por su ID, solo realice un PATCH como se muestra en la imagen:

![](/imagenes/05.png)

## Eliminar un producto por ID:

Para poder eliminar un producto por su ID, solo realice un DELETE como se muestra en la imagen:
